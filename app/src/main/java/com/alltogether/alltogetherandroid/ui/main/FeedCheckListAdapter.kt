...
class FeedCheckListAdapter(private val checkList: ArrayList<Check>, private val viewModel: FeedViewModel) : RecyclerView.Adapter<FeedCheckListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.feed_check_item, parent, false))
    }
